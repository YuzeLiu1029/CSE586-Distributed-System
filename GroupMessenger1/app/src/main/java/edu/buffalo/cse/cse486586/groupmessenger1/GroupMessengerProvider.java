...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
         ...
         */
        /******************************************************************************************/
        //Below are the data added by Yuze
        /* Set<Map.Entry<String, Object>> s = values.valueSet();
        Iterator itr = s.iterator();
        while(itr.hasNext()){
            Map.Entry me = (Map.Entry)itr.next();
            String keyV = me.getKey().toString();
            String valueOfK = me.getValue().toString();
            try{
                //FileOutputStream fos = new FileOutputStream(tempFile);
                FileOutputStream fos = getContext().openFileOutput(keyV, Context.MODE_PRIVATE);
                fos.write(valueOfK.getBytes());
                fos.close();
            } catch(Exception e){
                Log.e("GroupMessenger","Fail to write to the file.");
            }
        }*/
